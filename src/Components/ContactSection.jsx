...
const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem(
      'contactMessages',
      JSON.stringify([...storedMessages, formData])
    );
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16 space-y-16">
      {/* Contact Info */}
      <div className="grid grid-cols-1 md:grid-cols-3 border border-dashed divide-x divide-dashed divide-gray-300">
        {/* Phone */}
      ...
      <div className="bg-white shadow-md rounded-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <input
            ...
            className="px-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 col-span-1"
            required
          />
          <input
            type="email"
          ...
          <input
            ...
            onChange={handleChange}
            className="px-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 col-span-full"
          />
          <textarea
            name="message"
          ...
          <button
            type="submit"
            className="bg-orange-500 text-white py-3 px-6 rounded hover:bg-orange-600 transition w-full md:w-auto col-span-full"
          >
            Send Message
          </button>
        </form>
