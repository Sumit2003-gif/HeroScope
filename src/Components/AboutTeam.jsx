        ...
        <div className="p-5 text-center flex flex-col flex-grow">
          ...
          <div className="flex border-t border-gray-200 text-gray-600 text-sm mt-auto">
            <button
              ...
              className="flex-grow py-3 hover:bg-gray-100 flex items-center justify-center space-x-2 focus:outline-none focus:ring-2 focus:ring-orange-400 transition"
            >
            ...
            <button
              type="button"
              onClick={onCallNow}
              className="flex-grow py-3 border-l border-gray-200 hover:bg-gray-100 flex items-center justify-center space-x-2 focus:outline-none focus:ring-2 focus:ring-orange-400 transition"
            >
